...
public struct AdobeGlyphList {
    ...
    public static func glyphName(for UV: UVBMP) -> String? {
        ...
        // a trailing %, which isn't actually part of the glyph name itself. Trim it off if present.
    ...
    fileprivate static let percentSet: CharacterSet = ["%"]
}

// MARK: - Glyph Name to UV
...
/// MD: This is derived from agl2uv.h in Adobe Font Development Kit for OpenType (AFDKO)
 ...
 */
/// MD: This is derived from uv2agl.h in Adobe Font Development Kit for OpenType (AFDKO):
/// https://github.com/adobe-type-tools/afdko
/// https://github.com/adobe-type-tools/afdko/blob/develop/c/shared/resource/uv2agl.h
/// MD: turned this into a Swift dictionary for quick lookup
fileprivate let uv2agl: [UVBMP: String] = [
    0x0020: "space",
    0x0021: "exclam",
    0x0022: "quotedbl",
    0x0023: "numbersign",
...
// MARK: - ZapfDingbat Glyph Name to UV
/* Copyright 2014 Adobe Systems Incorporated (http://www.adobe.com/). All Rights Reserved.
   This software is licensed as OpenSource, under the Apache License, Version 2.0.
   This license is available at: http://opensource.org/licenses/Apache-2.0. */
...
/// MD: This is derived from zding2uv.h in Adobe Font Development Kit for OpenType (AFDKO)
/// https://github.com/adobe-type-tools/afdko
/// https://github.com/adobe-type-tools/afdko/blob/develop/c/shared/resource/zding2uv.h
/// MD: turned this into a Swift dictionary for quick lookup
fileprivate let zding2uv: [String: UVBMP] = [
    "a1":      0x2701,
    "a10":     0x2721,
    "a100":    0x275E,
    "a101":    0x2761,
...
// MARK: - UV to ZapfDingbat Glyph Name
/* Copyright 2014 Adobe Systems Incorporated (http://www.adobe.com/). All Rights Reserved.
   This software is licensed as OpenSource, under the Apache License, Version 2.0.
   This license is available at: http://opensource.org/licenses/Apache-2.0. */
...
/// MD: This is derived from uv2zding.h in Adobe Font Development Kit for OpenType (AFDKO)
/// https://github.com/adobe-type-tools/afdko
/// https://github.com/adobe-type-tools/afdko/blob/develop/c/shared/resource/uv2zding.h
/// MD: turned this into a Swift dictionary for quick lookup
fileprivate let uv2zding: [UVBMP: String] = [
    0x0020:   "space",
    0x2192:    "a161",
    0x2194:    "a163",
    0x2195:    "a164",
