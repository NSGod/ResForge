...
final public class FOND: NSObject {
    ...
    @objc dynamic public var famID:         ResID           /// family ID number; `must match FOND resource ID`
    @objc dynamic public var firstChar:     Int16           /// ASCII code of 1st character
    @objc dynamic public var lastChar:      Int16           /// ASCII code of last character
    @objc dynamic public var ascent:        Fixed4Dot12     /// maximum ascent for 1pt font;  Fixed 4.12
    @objc dynamic public var descent:       Fixed4Dot12     /// maximum descent for 1pt font; Fixed 4.12
    ...
    @objc dynamic public var ewSBold:       Fixed4Dot12
    @objc dynamic public var ewSItalic:     Fixed4Dot12
    @objc dynamic public var ewSUnderline:  Fixed4Dot12
    @objc dynamic public var ewSOutline:    Fixed4Dot12
    @objc dynamic public var ewSShadow:     Fixed4Dot12
    @objc dynamic public var ewSCondensed:  Fixed4Dot12
    @objc dynamic public var ewSExtended:   Fixed4Dot12
    @objc dynamic public var ewSUnused:     Fixed4Dot12     /// unused; should be 0

    @objc dynamic public var intl0:         Int16           /// for international use
    @objc dynamic public var intl1:         Int16           /// for international use
