...
public final class FontTable_OS2: FontTable {
    ...
    public required init(with tableData: Data, tableTag: TableTag, fontFile: OTFFontFile) throws {
        ...
        do {
            ...
            NSLog("\(type(of: self)).\(#function) *** WARNING: Failed to read all expected fields for FontTable_OS2.version\(version.rawValue), falling back to .version\(targetVersion.rawValue); byte count: \(tableData.count)")
