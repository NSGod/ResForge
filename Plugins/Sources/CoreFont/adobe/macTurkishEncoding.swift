...
/* Mac OS Turkish aggregate Unicode initializer.

   Element values are UVs. UV_UNDEF is 0xFFFF. Index by code, get UV.
   Source: ftp://ftp.unicode.org/Public/MAPPINGS/VENDORS/APPLE/TURKISH.TXT
   as of 9/9/99. */
...
let macTurkishEncoding: [UVBMP] = [
    ...
    0x011E,       /* DA  LATIN CAPITAL LETTER G WITH BREVE */
    0x011F,       /* DB  LATIN SMALL LETTER G WITH BREVE */
    0x0130,       /* DC  LATIN CAPITAL LETTER I WITH DOT ABOVE */
    0x0131,       /* DD  LATIN SMALL LETTER DOTLESS I */
    0x015E,       /* DE  LATIN CAPITAL LETTER S WITH CEDILLA */
    0x015F,       /* DF  LATIN SMALL LETTER S WITH CEDILLA */
...
let uvsToMacTurkish: [UVBMP: CharCode] = [
    0x0020:       0x20, /*  SPACE */
