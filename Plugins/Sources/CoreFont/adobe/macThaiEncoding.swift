...
let uvsToMacThai: [UVBMP: CharCode] = [
    0x0020:       0x20, /*  SPACE */
    ...
    0xF88C:       0x83, /*  THAI CHARACTER MAI EK, low left position (0x0E48+0xF875) */
    0xF88F:       0x84, /*  THAI CHARACTER MAI THO, low left position (0x0E49+0xF875) */
    0xF892:       0x85, /*  THAI CHARACTER MAI TRI, low left position (0x0E4A+0xF875) */
    0xF895:       0x86, /*  THAI CHARACTER MAI CHATTAWA, low left position (0x0E4B+0xF875) */
    0xF898:       0x87, /*  THAI CHARACTER THANTHAKHAT, low left position (0x0E4C+0xF875) */
    0xF88B:       0x88, /*  THAI CHARACTER MAI EK, low position (0x0E48+0xF873) */
    0xF88E:       0x89, /*  THAI CHARACTER MAI THO, low position (0x0E49+0xF873) */
    0xF891:       0x8A, /*  THAI CHARACTER MAI TRI, low position (0x0E4A+0xF873) */
    0xF894:       0x8B, /*  THAI CHARACTER MAI CHATTAWA, low position (0x0E4B+0xF873) */
    0xF897:       0x8C, /*  THAI CHARACTER THANTHAKHAT, low position (0x0E4C+0xF873) */
    0x201C:       0x8D, /*  LEFT DOUBLE QUOTATION MARK */
    0x201D:       0x8E, /*  RIGHT DOUBLE QUOTATION MARK */
    0xF899:       0x8F, /*  THAI CHARACTER NIKHAHIT, left position (0x0E4D+0xF874) */
    0x2022:       0x91, /*  BULLET */
    0xF884:       0x92, /*  THAI CHARACTER MAI HAN-AKAT, left position (0x0E31+0xF874) */
    0xF889:       0x93, /*  THAI CHARACTER MAITAIKHU, left position (0x0E47+0xF874) */
    0xF885:       0x94, /*  THAI CHARACTER SARA I, left position (0x0E34+0xF874) */
    0xF886:       0x95, /*  THAI CHARACTER SARA II, left position (0x0E35+0xF874) */
    0xF887:       0x96, /*  THAI CHARACTER SARA UE, left position (0x0E36+0xF874) */
    0xF888:       0x97, /*  THAI CHARACTER SARA UEE, left position (0x0E37+0xF874) */
    0xF88A:       0x98, /*  THAI CHARACTER MAI EK, left position (0x0E48+0xF874) */
    0xF88D:       0x99, /*  THAI CHARACTER MAI THO, left position (0x0E49+0xF874) */
    0xF890:       0x9A, /*  THAI CHARACTER MAI TRI, left position (0x0E4A+0xF874) */
    0xF893:       0x9B, /*  THAI CHARACTER MAI CHATTAWA, left position (0x0E4B+0xF874) */
    0xF896:       0x9C, /*  THAI CHARACTER THANTHAKHAT, left position (0x0E4C+0xF874) */
