...
/* Mac OS Romanian aggregate Unicode initializer.

   Element values are UVs. UV_UNDEF is 0xFFFF. Index by code, get UV.
   Source: ftp://ftp.unicode.org/Public/MAPPINGS/VENDORS/APPLE/ROMANIAN.TXT
   as of 9/9/99, with EURO SIGN replacing CURRENCY SIGN.

   4 entries are mapped to Unicode 3.0 values for which Apple has defined a
   decomposition sequence in the source file above. The decomposition sequence
   is shown in parentheses for such mappings. */
/*
 # Format:
 # -------
 #
...
let macRomanianEncoding: [UVBMP] = [
    ...
    0x0102,       /* AE  LATIN CAPITAL LETTER A WITH BREVE */
    0x0218,       /* AF  LATIN CAPITAL LETTER S + COMBINING COMMA BELOW (0x0053+0x0326) */
    0x221E,       /* B0  INFINITY */
    ...
    0x0103,       /* BE  LATIN SMALL LETTER A WITH BREVE */
    0x0219,       /* BF  LATIN SMALL LETTER S + COMBINING COMMA BELOW (0x0073+0x0326) */
    ...
    0x021A,       /* DE  LATIN CAPITAL LETTER T + COMBINING COMMA BELOW (0x0054+0x0326) */
    0x021B,       /* DF  LATIN SMALL LETTER T + COMBINING COMMA BELOW (0x0074+0x0326) */
...
let uvsToMacRomanian: [UVBMP: CharCode] = [
    0x0020:       0x20, /*  SPACE */
    ...
    0x0218:       0xAF, /*  LATIN CAPITAL LETTER S + COMBINING COMMA BELOW (0x0053+0x0326) */
    ...
    0x0219:       0xBF, /*  LATIN SMALL LETTER S + COMBINING COMMA BELOW (0x0073+0x0326) */
    ...
    0x021A:       0xDE, /*  LATIN CAPITAL LETTER T + COMBINING COMMA BELOW (0x0054+0x0326) */
    0x021B:       0xDF, /*  LATIN SMALL LETTER T + COMBINING COMMA BELOW (0x0074+0x0326) */
